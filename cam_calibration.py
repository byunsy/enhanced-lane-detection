...
#     calib_images = glob.glob("./Projects/lane_detection_2/distorted/calibration*.jpg")
...
#             # Draw these corners on given image
#             # img = cv2.drawChessboardCorners(img, (9,6), corners2, ret)
#             # cv2.imshow("Chessboards", img)
#             # cv2.waitKey(0)
...
#         cv2.imwrite(
#             "./Projects/lane_detection_2/undistorted/undistorted{}.jpg".format(save_name), undistorted_cropped)
